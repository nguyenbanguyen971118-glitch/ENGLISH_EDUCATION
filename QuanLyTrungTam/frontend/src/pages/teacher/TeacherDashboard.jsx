...
const TeacherDashboard = () => {
    ...
    // 1. Stats thực tế cho Giáo viên (Dữ liệu tổng quan)
    const [stats] = useState([
        { label: 'Lớp đang dạy', value: '03', bg: 'linear-gradient(135deg, #0d6efd 0%, #0dcaf0 100%)', icon: 'bi-door-open' },
        ...
        { label: 'Yêu cầu hỗ trợ', value: '02', bg: 'linear-gradient(135deg, #dc3545 0%, #ffc107 100%)', icon: 'bi-chat-dots' }
    ]);

    // 2. Dữ liệu lớp học khớp với mã lớp HNI-PRI4-0065 của học sinh/phụ huynh
    const todayClasses = [
    ...
    return (
        <div className="animate__animated animate__fadeIn p-1">
            ...
            {/* --- HEADER: CHÀO MỪNG & HỌC KỲ --- */}
            <div className="d-flex justify-content-between align-items-start mb-4">
                <div>
                    {/* Hiển thị tên Giảng viên lấy từ hoTen hoặc fullName */}
                    <h2 className="fw-bold text-dark mb-1">
                        Xin chào, <span className="text-primary">{user?.hoTen || user?.fullName || 'Thầy/Cô'}</span>
                    </h2>
                ...
                <div className="text-end">
                    <div className="bg-white p-2 px-3 rounded-4 shadow-sm border d-flex align-items-center">
                        <div className="bg-primary-subtle p-2 rounded-3 me-3 d-none d-sm-block">
                            <i className="bi bi-calendar-check text-primary"></i>
                        </div>
                        <div className="text-start">
                            <span className="small text-muted d-block fw-bold" style={{fontSize: '9px', letterSpacing: '1px'}}>HỌC KỲ HIỆN TẠI</span>
            ...
            <div className="row g-4">
                ...
                <div className="col-lg-8">
                    <div className="card border-0 shadow-sm rounded-5 p-4 bg-white h-100">
                        <div className="d-flex justify-content-between align-items-center mb-4 px-2">
                            <h5 className="fw-bold mb-0">Lịch dạy hôm nay</h5>
                            <span className="badge bg-light text-primary border rounded-pill px-3 py-2 small fw-bold">Thứ Năm, 26/02</span>
                        </div>
                                    ...
                                    {todayClasses.map(cls => (
                                        <tr key={cls.id} className="transition-all">
                                            ...
                                            <td className="text-end pe-4">
                                                <button className="btn btn-primary rounded-pill btn-sm px-3 shadow-sm hover-up" style={{fontSize: '12px'}}>
                ...
                <div className="col-lg-4">
                    ...
                    {/* Card Trao đổi Phụ huynh (Light Blue Theme) */}
                    <div className="card border-0 shadow-sm rounded-5 p-4 bg-primary-subtle border border-primary border-opacity-10">
                        ...
                        <div className="bg-white rounded-4 p-3 mb-3 shadow-sm">
                            <div className="d-flex align-items-center mb-2">
                                <img 
                                    src={`https://ui-avatars.com/api/?name=Hung+Parent&background=0d6efd&color=fff&bold=true`} 
                                    className="rounded-circle me-2" 
                                    width="28" 
                                    height="28" 
                                    alt="parent"
                                />
                                <span className="fw-bold small text-dark">PH Em Nguyễn Văn Hùng</span>
                            </div>
                            <p className="text-muted mb-0" style={{fontSize: '11px', lineHeight: '1.4'}}>
                                "Cô ơi, nhờ thầy kiểm tra giúp em bài tập về nhà lớp PRI4 hôm qua ạ..."
                            </p>
                        </div>
                        <button className="btn btn-primary w-100 rounded-pill py-2 small fw-bold shadow-sm transition-all">
